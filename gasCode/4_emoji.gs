...
function searchEmoji(name, emojiList) {
    var code = name;
    ...
    var isCustom = (code.indexOf("https://") == 0);
    return { code: code, isCustom: isCustom };
}
function createEmojiList(token) {
    // 組み込み絵文字のリスト
    var emojiList = {
        "100": "&#x1F4AF;",
        "1234": "&#x1F522;",
    ...
    var customEmojiList = emojiListAPI(token);
